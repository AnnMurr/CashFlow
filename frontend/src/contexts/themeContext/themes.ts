...
export const Themes: ThemesType = {
    green: {
        ...
        selectHover: Colors.DARK_GREEN_TRANSPARENT,
    ...
    dark: {
        ...
        modalBackground: Colors.COD_GRAY_DARK,
